...
const DOC_LINKS = [
  ...
  { label: "Collections API", href: "/developers/collections", icon: "payments", description: "Push USSD, STK Push, or Selcom Pesa Push." },
  ...
  { label: "Webhooks", href: "/developers/webhooks", icon: "webhook", description: "Event types, payloads, and signature verification." },
