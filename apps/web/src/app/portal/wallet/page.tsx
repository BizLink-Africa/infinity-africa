...
import { getAvailableBalance, listWalletAccounts, listWalletLedger } from "@/lib/portal/api";
import type { WalletAccount, WalletLedgerEntry } from "@/lib/portal/types";
...
export default function WalletPage() {
  ...
  useEffect(() => {
    ...
    listWalletAccounts().then(setAccounts);
      ...
      <Card>
        ...
        {accounts.length === 0 ? (
          <p className="text-sm text-on-surface-variant py-2">
            No linked withdrawal accounts yet — a withdrawal&apos;s destination is entered fresh each time for now.
          </p>
        ) : (
